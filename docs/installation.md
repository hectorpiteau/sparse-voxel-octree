...
This page shows the currently supported install paths first, then the commands
to build, test, and diagnose the package locally. The project is CPU-wheel-first
today; CUDA is supported through source builds.
